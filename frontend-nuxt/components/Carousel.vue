...
.poster-image-wrapper {
  width: 320px;  /* scaled down from 360px */
  height: 480px; /* scaled down from 540px */
  flex-shrink: 0;
  display: flex;
  align-items: center;
...
.carousel-card img {
  ...
  height: 100%;
  object-fit: cover;
  border-radius: 14px; /* slightly smaller rounding */
}

/* Centered or hovered card enlarges */
.carousel-card.center,
.carousel-card.hovered {
  transform: scale(1.08); /* slightly reduced enlargement */
